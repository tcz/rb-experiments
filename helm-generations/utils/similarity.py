...
SCREENSHOTS_DATA_DIR = 'screenshots'
...
def take_screenshot(url, path, viewport_width, viewport_height):
...
def calculate_metrics(predicted_markup, expected_markup, viewport_width, viewport_height):
    ...
    import uuid
    id = uuid.uuid4().hex
    predicted_screenshot_path = os.path.join(SCREENSHOTS_DATA_DIR, f'{id}_predicted.png')
    expected_screenshot_path = os.path.join(SCREENSHOTS_DATA_DIR, f'{id}_expected.png')
